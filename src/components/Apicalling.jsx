...
function Apicalling() {
    ...
    useEffect(()=>{
        const API='https://www.swiggy.com/mapi/restaurants/list/v5?offset=0&is-seo-homepage-enabled=true&lat=27.563074862633712&lng=77.68681056797504&carousel=true&third_party_vendor=1'
